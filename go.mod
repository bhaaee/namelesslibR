module github.com/bhaaee/namelesslibR
...
require (
	...
	github.com/mukswilly/psiphon-tunnel-core v2.0.15+incompatible
	github.com/mxbhaee/NamelessnetLibV v0.0.0-20220128121120-ae71d4c0f4e1
